...
class creaPreventivoCure extends preventivoAbstract {
	...
	public static $azioneCure = "../paziente/creaPreventivoCureFacade.class.php?modo=go";
	public static $azioneDentiSingoli = "../paziente/creaPreventivoFacade.class.php?modo=start";
