...
class medico extends strumentiAbstract {

	public static $queryRegoleConfigurazioni = "/strumenti/ricercaRegoleConfigurazioni.sql";
	public static $queryCreaMedico = "/impostazioni/creaMedico.sql";
	...
	public function start($db, $utility, $row) {
		...
		*/
		if ($temp != "") {
			$this->inserisciDati($db, $utility, $row, self::$queryCreaMedico, $temp, $rows);
			return TRUE;
		}
		else {
			return FALSE;
