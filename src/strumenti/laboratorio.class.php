...
class laboratorio extends strumentiAbstract {

	public static $queryRegoleConfigurazioni = "/strumenti/ricercaRegoleConfigurazioni.sql";
	public static $queryCreaLaboratorio = "/impostazioni/creaLaboratorio.sql";
	...
	public function start($db, $utility, $row) {
		...
		*/
		if ($temp != "") {
			$this->inserisciDati($db, $utility, $row, self::$queryCreaLaboratorio, $temp, $rows);
			return TRUE;
		}
		else {
			return FALSE;
